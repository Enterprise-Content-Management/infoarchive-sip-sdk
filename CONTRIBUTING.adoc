...
organization to transfer ownership of the intellectual property to us. We're not going to ask you to fill out some kind 
of Contributor License Agreement (although we may in the future), but you should make sure you're covered.
