...
class WhenDiffingYaml {
  ...
  @Test
  void shouldReportNothingForEqualYamls() {
  ...
  @Test
  void shouldReportDifferentPropertiesButNotEqualOnes() {
    assertDiff(
  ...
  @Test
  void shouldReportMissingProperties() {
    assertDiff(
  ...
  @Test
  void shouldCompareNullProperly() {
  ...
  @Test
  void shouldCompareMapsOnlyWithMaps() {
    YamlMap mapWithValue = new YamlMap().put(NAME1, VALUE1);
  ...
  @Test
  void shouldCompareListsOnlyWithLists() {
    YamlMap mapWithValue = new YamlMap().put(NAME1, VALUE1);
