...
++++
<script type='text/javascript' src='https://www.openhub.net/p/infoarchive-sdk/widgets/project_thin_badge?format=js'></script>
++++
...
----
dependencies { 
  compile 'com.opentext.ia:infoarchive-sdk-core:9.11.2'
}
----
