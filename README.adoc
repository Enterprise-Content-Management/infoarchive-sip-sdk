...
image:https://sonarcloud.io/api/badges/measure?key=com.opentext.ia:infoarchive-sdk-core&metric=sqale_debt_ratio[title="Technical Debt", link="https://sonarcloud.io/dashboard?id=com.opentext.ia:infoarchive-sdk-core"]
...
----
dependencies { 
  compile 'com.opentext.ia:infoarchive-sip-sdk-core:6.0.0'
}
----
