...
https://github.com/Enterprise-Content-Management/infoarchive-sip-sdk/wiki/breaking-changes[rreaking changes] are
...
include::https://raw.githubusercontent.com/Enterprise-Content-Management/infoarchive-sip-sdk/master/LICENSE
