...
* `infoarchive-yaml` contains code for working with InfoArchive https://github.com/Enterprise-Content-Management/infoarchive-sip-sdk/wiki/Declarative-Configuration[declarative configurations] in YAML
...
----
dependencies { 
  compile 'com.opentext.ia:infoarchive-sdk-core:11.0.1'
}
----
