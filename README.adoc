...
image:https://sonarcloud.io/api/project_badges/measure?project=com.opentext.ia:infoarchive-sdk&metric=sqale_rating[title="Technical Debt", link="https://sonarcloud.io/dashboard?id=com.opentext.ia:infoarchive-sdk"]
image:https://snyk.io/test/github/Enterprise-Content-Management/infoarchive-sip-sdk/badge.svg[title="Known Vulnerabilities", link="https://snyk.io/test/github/Enterprise-Content-Management/infoarchive-sip-sdk"]
...
All jars can be found in the https://repo1.maven.org/maven2/com/opentext/ia/[Central Repository]. The easiest way to get
...
----
dependencies { 
  compile 'com.opentext.ia:infoarchive-sdk-core:11.0.0'
}
----
