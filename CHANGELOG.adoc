...
- Target to rebuild and publish again, in order to fix issues incorrect JDK version, stick to OpenJDK 11 instead

== 12.4.3 - published on 2021-09-08, with issues found (JDK version is incorrect)
