...
-  Upgrade httpclient from v4 to v5.6.1
-  Upgrade jackson from v2 to v3.2.2
-  Upgrade 3rd-party lib such as commons-io commons-lang3 to the latest.

== 12.8.7 = 2026-08-25

-  Make clientSecret property optional

== 12.8.6 = 2026-08-20

- Replace javax.validation:validation-api:2.0.1.Final library with Jakarta Validation (jakarta.* namespace).
- OAuth token endpoint moved from /oauth/token → /oauth2/token after Gateway upgrade

== 12.8.5 = 2026-01-27

- Upgrade commons-beanutils from 1.9.4 to 2.0.0-M2
- Update publish-plugin for gradle-nexus from 1.1.x to 2.0.0, due to the existing OSSRH service reaches EOL.
