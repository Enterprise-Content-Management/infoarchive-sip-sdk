...
== 12.6.7 - 2022-10-24
 ...
 - tested version to totally remove stringtemplate sub-project

== 12.6.6 - 2022-10-24

 - tested version for SDK refactory - stringtemplate sub-project removal

== 12.6.5 - 2022-10-18

 - tested version for SDK refactory - yaml project cleanup and configuration project removal

== 12.6.5.rc1 - 2022-10-12

- Still tested for yaml cleanup refactory
