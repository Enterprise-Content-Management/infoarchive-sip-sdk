...
/**
 * <a href="http://public.ccsds.org/publications/archive/650x0m2.pdf">Packaging
 * Information</a> for a Submission Information Package (SIP), describing the
 * contents of the SIP. It is probably easiest created using a
...
public class PackagingInformation {
	...
	public String toString() {
		return getClass().getSimpleName() + " [dss=" + dss + ", productionDate=" + productionDate + ", sequenceNumber="
				+ sequenceNumber + ", isLast=" + last + ", aiuCount=" + aiuCount + ", pageCount=" + pageCount
				+ ", hashes=" + pdiHash + ", externalId=" + externalId + "]";
	}

	/**
	 * @return A <a href="http://c2.com/cgi/wiki?BuilderPattern">builder</a> object
	 *         to construct {@linkplain PackagingInformation}
	 */
	...
	public static PackagingInformationBuilder builder(PackagingInformation prototype) {
		PackagingInformationBuilder result = builder().dss(prototype.getDss()).last(prototype.isLast())
				.pageCount(prototype.getPageCount()).productionDate(prototype.getProductionDate())
	...
	/**
	 * <a href="http://c2.com/cgi/wiki?BuilderPattern">Builder</a> object to
	 * construct {@linkplain PackagingInformation}.
	 */
	public static class PackagingInformationBuilder {
		...
		public PackagingInformation build() {
			return new PackagingInformation(dssBuilder.build(), productionDate, sequenceNumber, isLast, aiuCount,
					pageCount, encodedHash, customAttributes, externalId);
		}
