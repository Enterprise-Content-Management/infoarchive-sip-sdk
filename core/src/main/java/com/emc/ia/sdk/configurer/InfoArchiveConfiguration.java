...
public interface InfoArchiveConfiguration {
  ...
  String EXPORT_CONFIG_TRANSFORMATIONS_PORTNAME_TEMPLATE = EXPORT_CONFIG_TEMPLATE_PREFIX + "transformations.portname";
  String EXPORT_CONFIG_TRANSFORMATIONS_TRANSFORMATION_TEMPLATE = EXPORT_CONFIG_TEMPLATE_PREFIX + "transformations.transformation";
  String EXPORT_CONFIG_OPTIONS_XSL_RESULTFORMAT_TEMPLATE = EXPORT_CONFIG_TEMPLATE_PREFIX + "options.xslresultformat";
  String EXPORT_CONFIG_OPTIONS_XQUERY_RESULTFORMAT_TEMPLATE = EXPORT_CONFIG_TEMPLATE_PREFIX + "options.xqueryresultformat";
