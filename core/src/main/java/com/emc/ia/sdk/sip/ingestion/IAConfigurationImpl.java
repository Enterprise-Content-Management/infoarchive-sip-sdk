...
public class IAConfigurationImpl implements IAConfiguration{
  ...
  private static final String LINKAPIS = "http://identifiers.emc.com/aips";  
  private static final String LINKTENANT = "http://identifiers.emc.com/tenant";
  private static final String LINKAPPLICATION = "http://identifiers.emc.com/applications";
  ...
  private void setTenant(String resourceUrl) {
    ...
    Link tenantLink = homeResource.getLinks().get(LINKTENANT);
  ...
  private void setApplication(String applicationName) {
    Link applicationsLink = tenant.getLinks().get(LINKAPPLICATION);
  ...
  private void setAipsHref() {
    Link aipsLink = application.getLinks().get(LINKAPIS);
